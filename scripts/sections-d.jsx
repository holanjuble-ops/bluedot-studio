...
function ColumnTeaser() {
  ...
  const items = [
    { tag: '시작 가이드', title: '나도 숏폼이 필요할까?', href: 'column/shortform-marketing-needed.html' },
    { tag: '대표 사례', title: '릴스 2개로 100만 조회수, 그 안에 숨은 공식', href: 'column/reels-million-views.html' },
    { tag: '시작 가이드', title: '‘문의로 이어지는 숏폼’은 이게 다릅니다', href: 'column/shortform-inquiry-conversion.html' }
  ];
